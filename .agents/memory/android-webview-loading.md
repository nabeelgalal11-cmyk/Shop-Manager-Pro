...
**Why:** An installed Android build displayed the production website behind a permanent native “Loading 915motors…” overlay because that device's System WebView did not emit the expected completion callback.
